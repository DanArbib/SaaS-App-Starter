...
const makeNavbarSticky = () => {
  ...
  const handleScroll = () => {
    ...
    if (window.pageYOffset > sticky) {
      ...
      logo.src = darkMode ? 'src/assets/logo/logo-darkmode.png' : 'src/assets/logo/logo.png';
    } else {
    ...
    >
      <div class="container">
        <div class="relative -mx-4 flex items-center justify-between">
          <div class="w-50 max-w-full px-4">
          ...
          <div class="flex w-full items-center justify-between px-4">
            ...
            <div class="flex items-center justify-end pr-16 lg:pr-0">
              ...
              <label
                for="themeSwitcher"
                class="inline-flex cursor-pointer items-center mx-2"
