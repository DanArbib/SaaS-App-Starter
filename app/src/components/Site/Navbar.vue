...
const handleNavbarToggler = () => {
  const navbarToggler = document.querySelector("#navbarToggler") as HTMLElement;
...
<template>
      <div class="container">
        <div class="relative -mx-4 flex items-center justify-between">
          <div class="w-45 max-w-full px-4">
            <router-link :to="{ name: 'home' }" class="navbar-logo block w-full py-5">
              <img
                src="/logo-light-120-60.png"
                alt="logo"
          ...
          <div class="flex w-full items-center justify-between px-4">
            ...
            <div class="flex items-center justify-end pr-16 lg:pr-0">
              ...
              <div class="hidden sm:flex">
                <router-link
                  :to="{ name: 'app' }"
                  class="loginBtn px-[26px] py-2 text-base font-medium text-white hover:opacity-70"
                >
                  Sign In
                </router-link>
                <router-link
                  :to="{ name: 'auth' }"
                  class="signUpBtn rounded-md bg-white bg-opacity-20 px-6 py-2 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-100 hover:text-bodydark2"
                >
                  Sign Up
                </router-link>
              </div>
